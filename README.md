# Hi there, I'm Amarnath <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="25px">

## A Geek, Gamer and an Automation Nerd !!

```console
$ whoami
amarnath-jamale · senior platform engineer @ catalystone solutions · oslo, norway

$ amar --capabilities | head -5
  ✓ backstage developer portal · golden paths · scaffolder templates
  ✓ crossplane control plane · 35+ self-service platform APIs
  ✓ flux gitops · hub-and-spoke fleet delivery
  ✓ zero-static-secrets workload identity (github oidc · aks · entra id)
  ✓ ansible fleet automation · 1000+ nodes · $3.5M saved annually
```

I build the platforms other engineers build on: a Backstage developer portal,
a Crossplane control plane, Flux-delivered Kubernetes runtimes, and the
automation that keeps a fleet of 1000+ servers boring, compliant, and fast
to ship to.

- 🔭 Currently shipping: an internal developer platform on Backstage, Crossplane, Flux, and Kyverno.
...
**[amar.jamale.org](https://amar.jamale.org)** (try the terminal, type `help`) · [amar@jamale.org](mailto:amar@jamale.org)

### Currently shipping

- **Internal developer platform**: Backstage with a software catalog, TechDocs,
  RBAC, and custom plugins across a multi-region AKS fleet
- **Infrastructure as an API**: Crossplane XRDs and compositions turning Azure,
  Entra ID, and Cloudflare into pull-request-driven self-service
- **GitOps everything**: Flux v2 hub-and-spoke, Kyverno policy gates, and
  GitHub itself managed as code

### Previously

Six years at Tata Consultancy Services, embedded with DNB Bank ASA: Azure
DevOps, Red Hat Ansible Automation Platform (80+ projects, 300+ roles),
RHEL/Solaris platform engineering, and compliance as code with OpenSCAP.

### Certified

`AZ-400` `AZ-204` `AZ-104` `AZ-900` · [verify on credly](https://www.credly.com/users/amarnath-jamale)
...
<img align="left" title="Go" alt="Go" width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg" style="padding-right:10px;" />
...
1. 💪 Opened PR [#304](undefined) in [crossplane-contrib/crossview](https://github.com/crossplane-contrib/crossview)
2. ❗️ Opened issue [#303](https://github.com/crossplane-contrib/crossview/issues/303) in [crossplane-contrib/crossview](https://github.com/crossplane-contrib/crossview)
3. ⬆️ Pushed undefined commit(s) to [amarnathjamale/crossview](https://github.com/amarnathjamale/crossview)
4. 🔱 Forked [amarnathjamale/crossview](https://github.com/amarnathjamale/crossview) from [crossplane-contrib/crossview](https://github.com/crossplane-contrib/crossview)
5. 💬 Commented on [#331](https://github.com/crossplane-contrib/provider-upjet-github/issues/331#issuecomment-5625881015) in [crossplane-contrib/provider-upjet-github](https://github.com/crossplane-contrib/provider-upjet-github)
<!--RECENT_ACTIVITY:end-->

<!--RECENT_ACTIVITY:last_update-->
Last Updated: Tuesday, September 22nd, 2026, 5:54:43 PM
...
[twitter]: https://twitter.com/amarnath_jamale
